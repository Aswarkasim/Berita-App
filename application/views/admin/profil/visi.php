...
<div class="card">
  ...
  <div class="card-body">
    <?php
        ...
        echo form_open_multipart('admin/profil/visi/');
     ?>
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          <div class="form-group">
            ...
            <textarea name="visi" class="editor form-control"><?php echo $profil->visi; ?></textarea>
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <div class="form-group">
            ...
            <textarea name="misi" class="editor form-control"><?php echo $profil->misi; ?></textarea>
          </div>
        </div>
      </div>
