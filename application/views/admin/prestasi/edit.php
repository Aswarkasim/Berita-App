...
<div class="card">
  ...
  <div class="card-body">
    <?php
        ...
        echo form_open_multipart('admin/prestasi/edit');
     ?>
    ...
    <form class="form-horizontal">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" name="nama_peraih" class="form-control" placeholder="Nama Peraih" value="<?php echo $prestasi->nama_peraih; ?>">
        </div>
      </div>
